...
function boolTrue() {
    document.getElementById("button").innerHTML = (53>51); // Returns True
}

function boolFalse() {
    document.getElementById("button1").innerHTML = (100<55);  // Returns False
}

function boolTrue1() {
    document.getElementById("button2").innerHTML = (51==51); // Returns True
}

function boolFalse1() {
    document.getElementById("button3").innerHTML = (15==35);  // Returns False
}

function boolTrue2() {
    document.getElementById("button4").innerHTML = ("57"==="57"); // Returns True
}

function boolFalse2() {
    document.getElementById("button5").innerHTML = (50==="21");  // Returns False
}

function boolFalse3() {
    document.getElementById("button6").innerHTML = (52==="52");  // Returns False
}

function boolFalse4() {
    document.getElementById("button7").innerHTML = (49===48);  // Returns False
}
