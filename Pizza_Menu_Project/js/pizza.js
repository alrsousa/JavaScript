...
function getVeg(runningTotal, text1) {
	let vegTotal = 0;
	let selectedVeg = [];
	// put number of vegables possibilities into array
	let vegArray = document.getElementsByClassName("vegs");
	console.log(vegArray);
	// Look through array to determine how many possibilities were selected
	...
	// each veg selected is passed  to `runningTotal` as $1
